...
function initScrollEffects() {
    ...
    // Observe elements for animation (currently none since we removed stats)
}
...
// Start deployment function - redirects to the form page
...
// Initialize typing effect for code lines
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function(e) {
            if (this.classList.contains('btn-primary') && !this.disabled) {
                ...
                // If this is the start button, trigger navigation after a short delay
